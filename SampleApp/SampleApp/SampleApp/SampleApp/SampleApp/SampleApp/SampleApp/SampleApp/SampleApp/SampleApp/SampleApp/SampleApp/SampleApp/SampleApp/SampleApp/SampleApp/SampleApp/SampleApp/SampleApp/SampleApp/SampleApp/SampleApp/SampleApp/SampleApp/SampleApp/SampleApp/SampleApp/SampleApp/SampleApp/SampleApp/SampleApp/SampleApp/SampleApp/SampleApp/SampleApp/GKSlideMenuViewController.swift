...
@objc public protocol GKSlideMenuControllerDelegate {
...
public class GKSlideMenuViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    public weak var delegate: GKSlideMenuControllerDelegate?
    ...
    public func addLeftGestures() {
        ...
        if (leftViewController != nil) {
            if leftPanGesture == nil {
                leftPanGesture = UIPanGestureRecognizer(target: self, action: #selector(GKSlideMenuViewController.handleLeftPanGesture(_:)))
                leftPanGesture!.delegate = self
                view.addGestureRecognizer(leftPanGesture!)
            }
            
            if leftTapGesture == nil {
                leftTapGesture = UITapGestureRecognizer(target: self, action: #selector(GKSlideMenuViewController.toggleLeft))
    ...
    public func changeMainViewController(mainViewController: UIViewController,  close: Bool) {
        let currentNavController = self.mainViewController as! UINavigationController
        let newNavController = mainViewController as! UINavigationController
        
        if (object_getClassName(currentNavController.topViewController) !=
            object_getClassName(newNavController.topViewController)) {
